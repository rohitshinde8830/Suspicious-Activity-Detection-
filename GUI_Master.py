...
heading = tk.Label(root,text="Anomaly Detection",width=25,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
...
def show_FDD_video(video_path):
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Suspicious event Detected"
            sms_send()
            color = red
...
button5 = tk.Button(root,command = Video_Verify, text="Anomaly Detection", width=20,font=("Times new roman", 25, "bold"),bg="cyan",fg="black")
