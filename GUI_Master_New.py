...
#==============================================================================
msg="Suspicious detected..."
def sms_send():
    url="https://www.fast2sms.com/dev/bulk"
    params={
 
        "authorization":"VEmyjGbHsKYogzeOXU7qIi4dh3DQwuncf8A6LCWRNM5F0a2tJxUcn3VAgCf8Y6LwE0ulebXydqGTtFNM",
        "sender_id":"SMSINI",
        "message":msg,
        "language":"english",
        "route":"p",
...
img = Image.open(basepath + "New5.jpg")
...
heading = tk.Label(root,text="Suspicious Activity Detection System",width=120,height=2,font=("Times New Roman",21,"italic"),bg="skyblue",fg="black")
...
def sms_send():
    ...
    params={
        ...
        "authorization":"VhZElsNiB2WajMyDKmtH85fIPp6LokdSuJgXFeG10zARUYvTxnEQiCcSyoJRW03AOXkZmNpvY8LHd6DV",
        "sender_id":"SMSINI",
        "message":msg,
        "language":"english",
        "route":"p",
...
def VIDEO():
    ...
    fn=""
    fileName = askopenfilename(initialdir='D:/100%_suspicios_activity_2/100% suspicios activity 2', title='Select image',
                               filetypes=[("all files", "*.*")])
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model(r'model.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            ...
            # import smtplib
            # os.system("so.mp4")
            # mailid = "Bitmap.sct@gmail.com"

            # msg = 'Accident detect please Help'

            # s = smtplib.SMTP('smtp.gmail.com', 587)
            # s.starttls()
            # s.login("falldetection36@gmail.com", "FALLdetection@123")
            # print(msg)
            # s.sendmail('falldetection36@gmail.com', mailid, msg)
            # color = red
            
           
            print('Suspicious Detected')
            #sms_send()
            # TTS = gTTS(text='Suspicious  Detected...')
...
button5 = tk.Button(root,command = Video_Verify, text="Activity Detection", width=20,font=("Tempus Sanc ITC",15),bg="cyan",fg="black")
button5.place(x=100,y=200)


button6 = tk.Button(root,command = train_model, text="Model_Train", width=20,font=("Tempus Sanc ITC",15),bg="cyan",fg="black")
